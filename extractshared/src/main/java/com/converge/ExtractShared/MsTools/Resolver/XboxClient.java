package com.converge.ExtractShared.MsTools.Resolver;
...
import com.converge.ExtractShared.MsTools.Resolver.authentication.AuthPayload;
import com.converge.ExtractShared.MsTools.Resolver.authorization.AuthorizationPayload;
import com.converge.ExtractShared.MsTools.Resolver.finalAuth.FinalAuth;
import com.converge.ExtractShared.MsTools.Resolver.loginpayload.Payload;
import com.converge.ExtractShared.MsTools.Resolver.token.Token;
...
public class XboxClient {
	...
	public String getSpecificClip(String uid, String scid, String clipId){
		String tempUrl = "https://gameclipsmetadata.xboxlive.com/users/xuid("+uid+")/scids/"+scid+"/clips/"+clipId;
		String clipMp4 = this.clientGet(tempUrl);
		return clipMp4;
	}
	
	private String clientGet(String url){
		...
		try {
			...
			conn.setRequestProperty("Authorization", this.getAuthorizationHeader());
