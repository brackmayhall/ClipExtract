...
public class DefaultSku_ {
    ...
    @Expose
    private List<Entitlement__> entitlements = new ArrayList<Entitlement__>();
    @SerializedName("id")
    @Expose
    private String id;
    ...
    public DefaultSku_ withAmortizeFlag(Boolean amortizeFlag) {
        this.amortizeFlag = amortizeFlag;
        return this;
    }
    ...
    public DefaultSku_ withBundleExclusiveFlag(Boolean bundleExclusiveFlag) {
        this.bundleExclusiveFlag = bundleExclusiveFlag;
        return this;
    }
    ...
    public DefaultSku_ withChargeImmediatelyFlag(Boolean chargeImmediatelyFlag) {
        this.chargeImmediatelyFlag = chargeImmediatelyFlag;
        return this;
    }
    ...
    public DefaultSku_ withChargeTypeId(Long chargeTypeId) {
        this.chargeTypeId = chargeTypeId;
        return this;
    }
    ...
    public DefaultSku_ withCreditCardRequiredFlag(Long creditCardRequiredFlag) {
        this.creditCardRequiredFlag = creditCardRequiredFlag;
        return this;
    }
    ...
    public DefaultSku_ withDefaultSku(Boolean defaultSku) {
        this.defaultSku = defaultSku;
        return this;
    }
    ...
    public DefaultSku_ withDisplayPrice(String displayPrice) {
        this.displayPrice = displayPrice;
        return this;
    }
    ...
    public DefaultSku_ withEligibilities(List<Object> eligibilities) {
        this.eligibilities = eligibilities;
        return this;
    }
     ...
     *     The entitlements
     */
    public List<Entitlement__> getEntitlements() {
        return entitlements;
    }
     ...
     *     The entitlements
     */
    public void setEntitlements(List<Entitlement__> entitlements) {
        this.entitlements = entitlements;
    }

    public DefaultSku_ withEntitlements(List<Entitlement__> entitlements) {
        this.entitlements = entitlements;
        return this;
    }
    ...
    public DefaultSku_ withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public DefaultSku_ withIsOriginal(Boolean isOriginal) {
        this.isOriginal = isOriginal;
        return this;
    }
    ...
    public DefaultSku_ withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public DefaultSku_ withPlatforms(List<Long> platforms) {
        this.platforms = platforms;
        return this;
    }
    ...
    public DefaultSku_ withPrice(Long price) {
        this.price = price;
        return this;
    }
    ...
    public DefaultSku_ withRewards(List<Reward> rewards) {
        this.rewards = rewards;
        return this;
    }
    ...
    public DefaultSku_ withSeasonPassExclusiveFlag(Boolean seasonPassExclusiveFlag) {
        this.seasonPassExclusiveFlag = seasonPassExclusiveFlag;
        return this;
    }
    ...
    public DefaultSku_ withSkuAvailabilityOverrideFlag(Boolean skuAvailabilityOverrideFlag) {
        this.skuAvailabilityOverrideFlag = skuAvailabilityOverrideFlag;
        return this;
    }
    ...
    public DefaultSku_ withSkuType(Long skuType) {
        this.skuType = skuType;
        return this;
    }
    ...
    public DefaultSku_ withType(String type) {
        this.type = type;
        return this;
    }
