...
public class Entitlement__ {
    ...
    @Expose
    private List<Package__> packages = new ArrayList<Package__>();
    ...
    public Entitlement__ withDescription(Object description) {
        this.description = description;
        return this;
    }
    ...
    public Entitlement__ withDrms(List<Object> drms) {
        this.drms = drms;
        return this;
    }
    ...
    public Entitlement__ withDuration(Long duration) {
        this.duration = duration;
        return this;
    }
    ...
    public Entitlement__ withExpAfterFirstUse(Long expAfterFirstUse) {
        this.expAfterFirstUse = expAfterFirstUse;
        return this;
    }
    ...
    public Entitlement__ withFeatureTypeId(Long featureTypeId) {
        this.featureTypeId = featureTypeId;
        return this;
    }
    ...
    public Entitlement__ withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public Entitlement__ withLicenseType(Long licenseType) {
        this.licenseType = licenseType;
        return this;
    }
    ...
    public Entitlement__ withName(String name) {
        this.name = name;
        return this;
    }
     ...
     *     The packages
     */
    public List<Package__> getPackages() {
        return packages;
    }
     ...
     *     The packages
     */
    public void setPackages(List<Package__> packages) {
        this.packages = packages;
    }

    public Entitlement__ withPackages(List<Package__> packages) {
        this.packages = packages;
        return this;
    }
    ...
    public Entitlement__ withPreorderPlaceholderFlag(Boolean preorderPlaceholderFlag) {
        this.preorderPlaceholderFlag = preorderPlaceholderFlag;
        return this;
    }
    ...
    public Entitlement__ withSize(Long size) {
        this.size = size;
        return this;
    }
    ...
    public Entitlement__ withSubType(Long subType) {
        this.subType = subType;
        return this;
    }
    ...
    public Entitlement__ withSubtitleLanguageCodes(Object subtitleLanguageCodes) {
        this.subtitleLanguageCodes = subtitleLanguageCodes;
        return this;
    }
    ...
    public Entitlement__ withType(Long type) {
        this.type = type;
        return this;
    }
    ...
    public Entitlement__ withUseCount(Long useCount) {
        this.useCount = useCount;
        return this;
    }
    ...
    public Entitlement__ withVoiceLanguageCodes(Object voiceLanguageCodes) {
        this.voiceLanguageCodes = voiceLanguageCodes;
        return this;
    }
