...
public class Sku {
    ...
    @Expose
    private List<Entitlement_> entitlements = new ArrayList<Entitlement_>();
    @SerializedName("id")
    @Expose
    private String id;
    ...
    public Sku withAmortizeFlag(Boolean amortizeFlag) {
        this.amortizeFlag = amortizeFlag;
        return this;
    }
    ...
    public Sku withBundleExclusiveFlag(Boolean bundleExclusiveFlag) {
        this.bundleExclusiveFlag = bundleExclusiveFlag;
        return this;
    }
    ...
    public Sku withChargeImmediatelyFlag(Boolean chargeImmediatelyFlag) {
        this.chargeImmediatelyFlag = chargeImmediatelyFlag;
        return this;
    }
    ...
    public Sku withChargeTypeId(Long chargeTypeId) {
        this.chargeTypeId = chargeTypeId;
        return this;
    }
    ...
    public Sku withCreditCardRequiredFlag(Long creditCardRequiredFlag) {
        this.creditCardRequiredFlag = creditCardRequiredFlag;
        return this;
    }
    ...
    public Sku withDefaultSku(Boolean defaultSku) {
        this.defaultSku = defaultSku;
        return this;
    }
    ...
    public Sku withDisplayPrice(String displayPrice) {
        this.displayPrice = displayPrice;
        return this;
    }
    ...
    public Sku withEligibilities(List<Object> eligibilities) {
        this.eligibilities = eligibilities;
        return this;
    }
    ...
    public Sku withEntitlements(List<Entitlement_> entitlements) {
        this.entitlements = entitlements;
        return this;
    }
    ...
    public Sku withIsOriginal(Boolean isOriginal) {
        this.isOriginal = isOriginal;
        return this;
    }
    ...
    public Sku withPlatforms(List<Long> platforms) {
        this.platforms = platforms;
        return this;
    }
    ...
    public Sku withPrice(Long price) {
        this.price = price;
        return this;
    }
    ...
    public Sku withRewards(List<Object> rewards) {
        this.rewards = rewards;
        return this;
    }
    ...
    public Sku withSeasonPassExclusiveFlag(Boolean seasonPassExclusiveFlag) {
        this.seasonPassExclusiveFlag = seasonPassExclusiveFlag;
        return this;
    }
    ...
    public Sku withSkuAvailabilityOverrideFlag(Boolean skuAvailabilityOverrideFlag) {
        this.skuAvailabilityOverrideFlag = skuAvailabilityOverrideFlag;
        return this;
    }
    ...
    public Sku withSkuType(Long skuType) {
        this.skuType = skuType;
        return this;
    }
    ...
    public Sku withType(String type) {
        this.type = type;
        return this;
    }
